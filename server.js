...
mongoose.connect(process.env.MONGO_URI)
    .then(async () => {
        ...
        try {
            // Принудительно очищаем старых курьеров и записываем новые полные данные с Пн по Сб
            ...
            console.log('Все курьеры и их маршруты (Пн-Сб) успешно перезаписаны в базе!');
        } catch (err) {
